...
const journals: JournalEntry[] = [
  { year: '2026', authors: 'Mandal B., Jóźwiak H., Wcisło P., Naduvalath B.', title: 'Full-dimensional quantum scattering calculations of rovibrationally excited HD+HD collisions', journal: 'Journal of Chemical Physics, 164, 124308, 2026', href: 'https://doi.org/10.1063/5.0318268', image: '/Machine-Learning-in-Quantum-Dynamics/assets/TOC_HD_HD.png' },
  { year: '2026', authors: 'Stordock J., Mandal B., Naduvalath B.', title: 'Nuclear quantum effects on low energy resonant features in He+H₂ scattering', journal: 'Physical Review A, , 113, 042803, 2026', href: 'https://doi.org/10.1103/1vhq-6kh7', image: '/Machine-Learning-in-Quantum-Dynamics/assets/mass_scaling_cover.png' },
  { year: '2025', authors: 'Mandal B., Babikov D., Stancil P., Forrey R., Krems R., Naduvalath B.', title: 'Neural network ensemble for computing cross sections for rotational transitions in H₂O + H₂O collisions', journal: 'Physical Chemistry Chemical Physics, 27, 23000, 2025', note: "Honoring Prof. N. Sathyamurthy's 75th birthday", href: 'https://doi.org/10.1039/D5CP02812D', image: '/Machine-Learning-in-Quantum-Dynamics/assets/TOC.png' },
  ...
  { year: '2025', authors: 'Sanz-Sanz C.*, Mandal B.* (*equal contribution), Jambrina P., Aoiz F. J., Naduvalath B.', title: 'Cold collisions of highly vibrationally excited and aligned D₂ with Ne', journal: 'Journal of Chemical Physics, 162, 164307, 2025', href: 'https://doi.org/10.1063/5.0266360', image: '/Machine-Learning-in-Quantum-Dynamics/assets/Fig_D2_Ne_HSARP_XSARP_page-0001.jpg' },
  ...
  { year: '2024', authors: 'Joy C., Bostan D., Mandal B., Babikov D.', title: 'Rate coefficients for rotational state-to-state transitions in H₂O + H₂ collisions as predicted by mixed quantum/classical theory', journal: 'Astronomy & Astrophysics, 692, A229, 2024', href: 'https://doi.org/10.1051/0004-6361/202451975', image: '/Machine-Learning-in-Quantum-Dynamics/assets/H2O_H2_AA_cover.png' },
  { year: '2024', authors: 'Bostan D., Mandal B., Babikov D.', title: 'Mixed quantum/classical theory for rotationally inelastic scattering of identical collision partners revised', journal: 'Physical Chemistry Chemical Physics, 26, 27567, 2024', href: 'https://doi.org/10.1039/D4CP02806F', image: '/Machine-Learning-in-Quantum-Dynamics/assets/identical_cover.png' },
  { year: '2024', authors: 'Mandal B., Żółtowski M., Cordiner M., Lique F., Babikov D.', title: 'Rotational state-to-state transition rate coefficients for H₂O + H₂O collisions at non-equilibrium conditions', journal: 'Astronomy & Astrophysics, 688, A208, 2024', href: 'https://doi.org/10.1051/0004-6361/202450738', image: '/Machine-Learning-in-Quantum-Dynamics/assets/RADEX_cover.png' },
  ...
  { year: '2024', authors: 'Joy C., Mandal B., Bostan D., Dubernet M. L., Babikov D.', title: 'Mixed quantum/classical theory (MQCT) approach to the dynamics of molecule–molecule collisions in complex systems', journal: 'Faraday Discussions, 251, 225, 2024', href: 'https://doi.org/10.1039/D3FD00166K', image: '/Machine-Learning-in-Quantum-Dynamics/assets/H2O_H2_cover.png' },
  { year: '2024', authors: 'Bostan D., Mandal B., Joy C., Żółtowski M., Lique F., Loreau J., Quintas-Sánchez E., Batista-Planas A., Dawes R., Babikov D.', title: 'Mixed quantum/classical calculations of rotationally inelastic scattering in the CO + CO system', journal: 'Physical Chemistry Chemical Physics, 26, 6627, 2024', href: 'https://doi.org/10.1039/D3CP05369E', cover: true, image: '/Machine-Learning-in-Quantum-Dynamics/assets/PCCP_cover.png' },
  ...
  { year: '2024', authors: 'Mandal B., Bostan D., Joy C., Babikov D.', title: 'MQCT 2024: A program for calculations of inelastic scattering of two molecules', journal: 'Computer Physics Communications, 294, 108938, 2024', href: 'https://doi.org/10.1016/j.cpc.2023.108938', image: '/Machine-Learning-in-Quantum-Dynamics/assets/MQCT_2024_cover.png' },
  { year: '2023', authors: 'Mandal B., Babikov D.', title: 'Improved temperature dependence of rate coefficients for rotational state-to-state transitions in H₂O + H₂O collisions', journal: 'Astronomy & Astrophysics, 678, A51, 2023', href: 'https://doi.org/10.1051/0004-6361/202346895', image: '/Machine-Learning-in-Quantum-Dynamics/assets/H2O_H2O_2.png' },
  { year: '2023', authors: 'Joy C., Mandal B., Bostan D., Babikov D.', title: 'Mixed quantum/classical theory for rotational energy exchange in symmetric-top-rotor + linear-rotor collisions: ND₃ + D₂', journal: 'Physical Chemistry Chemical Physics, 25, 17287, 2023', href: 'https://doi.org/10.1039/D3CP01642K', image: '/Machine-Learning-in-Quantum-Dynamics/assets/ND3_D2_cover.png' },
  { year: '2023', authors: 'Bostan D., Mandal B., Joy C., Babikov D.', title: 'Description of quantum interference using mixed quantum/classical theory of inelastic scattering', journal: 'Physical Chemistry Chemical Physics, 25, 15683, 2023', href: 'https://doi.org/10.1039/D3CP01070H', image: '/Machine-Learning-in-Quantum-Dynamics/assets/N2_O_cover.png' },
  { year: '2023', authors: 'Mandal B., Babikov D.', title: 'Rate coefficients for rotational state-to-state transitions in H₂O + H₂O collisions for cometary and planetary applications', journal: 'Astronomy & Astrophysics, 671, A51, 2023', href: 'https://doi.org/10.1051/0004-6361/202245699', image: '/Machine-Learning-in-Quantum-Dynamics/assets/H2O_H2O_1.png' },
  ...
  { year: '2022', authors: 'Mandal B., Joy C., Semenov A., Babikov D.', title: 'Mixed quantum/classical theory for collisional quenching of PAHs in the interstellar media', journal: 'ACS Earth and Space Chemistry, 6, 521, 2022', href: 'https://doi.org/10.1021/acsearthspacechem.1c00418', image: '/Machine-Learning-in-Quantum-Dynamics/assets/C6H6_He_cover.png' },
  { year: '2020', authors: 'Mandal B., Semenov A., Babikov D.', title: 'Adiabatic trajectory approximation within the framework of mixed quantum/classical theory', journal: 'The Journal of Physical Chemistry A, 124, 9877, 2020', href: 'https://doi.org/10.1021/acs.jpca.0c07547', image: '/Machine-Learning-in-Quantum-Dynamics/assets/AT_MQCT_cover.png' },
  { year: '2020', authors: 'Boursier C., Mandal B., Dubernet M. L., Babikov D.', title: 'New H₂O-H₂O collisional rate coefficients for cometary applications', journal: 'Monthly Notices of the Royal Astronomical Society, 498, 5489, 2020', href: 'https://doi.org/10.1093/mnras/staa2713', image: '/Machine-Learning-in-Quantum-Dynamics/assets/H2O_H2O_MNRAS_cover.png' },
  { year: '2020', authors: 'Semenov A.*, Mandal B.* (*equal contribution), Babikov D.', title: 'MQCT: User-ready program for calculations of inelastic scattering of two molecules', journal: 'Computer Physics Communications, 252, 107155, 2020', href: 'https://doi.org/10.1016/j.cpc.2020.107155', image: '/Machine-Learning-in-Quantum-Dynamics/assets/MQCT_v1_cover.png' },
  { year: '2018', authors: 'Mandal B., Semenov A., Babikov D.', title: 'Calculations of differential cross sections using mixed quantum/classical theory of inelastic scattering', journal: 'The Journal of Physical Chemistry A, 122, 6157, 2018', href: 'https://doi.org/10.1021/acs.jpca.8b04025', image: '/Machine-Learning-in-Quantum-Dynamics/assets/N2_Na_cover.png' },
                    ...
                    <div className="max-md:hidden flex justify-center">
                      {p.image && (
                        <img 
                          src={p.image} 
                          alt="Paper Highlight" 
                          className="object-cover rounded border border-[#1a1a1a]/[0.05] shadow-sm group-hover:scale-110 transition-transform duration-300"
                        />
                      )}
                    </div>
                    <div className="pt-0.5 max-sm:hidden">
