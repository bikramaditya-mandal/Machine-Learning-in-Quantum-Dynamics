...
const journals: JournalEntry[] = [
  { year: '2026', authors: 'Mandal B., Jóźwiak H., Wcisło P., Naduvalath B.', title: 'Full-dimensional quantum scattering calculations of rovibrationally excited HD+HD collisions', journal: 'Journal of Chemical Physics, 164, 124308, 2026', href: 'https://doi.org/10.1063/5.0318268' },
  { year: '2026', authors: 'Stordock J., Mandal B., Naduvalath B.', title: 'Nuclear quantum effects on low energy resonant features in He+H₂ scattering', journal: 'Physical Review A, , 113, 042803, 2026', href: 'https://doi.org/10.1103/1vhq-6kh7' },
